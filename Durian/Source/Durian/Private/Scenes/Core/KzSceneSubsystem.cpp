...
void UKzSceneSubsystem::HandlePostLoadMap(UWorld* LoadedWorld)
{
	...
	if (TryCreateScene(LoadedWorld,PendingSceneDefinition, Scene))
	{
		CurrentScene = Scene;
	}
...
bool UKzSceneSubsystem::TryCreateScene(UWorld* World,const UKzSceneDefinition* SceneDefinition, UKzScene*& OutScene)
{
	OutScene = nullptr;
