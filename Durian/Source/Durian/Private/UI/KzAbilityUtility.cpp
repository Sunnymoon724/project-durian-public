...
FSlateBrush GetAbilityIconBrush(const EAbilityType AbilityType)
{
	...
	FSlateBrush Brush;
	Brush.SetResourceObject(MaterialPath ? LoadObject<UMaterialInterface>(nullptr, MaterialPath) : nullptr);
